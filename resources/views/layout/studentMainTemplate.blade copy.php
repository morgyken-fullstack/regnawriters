...
<head>
    ...
    <link rel="stylesheet" href="{{asset('theme/star-admin/endors/simple-line-icons/css/simple-line-icons.css')}}">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="../../index.html">
                        <img src="{{asset('theme/star-admin/images/logo.svg')}}" alt="logo" />
                    </a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="t{{asset('heme/star-admin/images/faces/face12.jp')}}g" alt="image"
                                        class="img-sm profile-pic">
                                </div>
                                <div class="preview-item-content flex-grow py-2">
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="t{{asset('heme/star-admin/images/faces/face1.jpg')}}" alt="image"
                                        class="img-sm profile-pic">
                                </div>
                                <div class="preview-item-content flex-grow py-2">
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="{{asset('theme/star-admin/images/faces/face1.jpg')}}"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face1.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Herman Beck
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face2.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Messsy Adam
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face3.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        John Richards
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face4.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Peter Meggik
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face5.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Edward
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face6.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        John Doe
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{asset('theme/star-admin/images/faces/face7.jpg')}}"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Henry Tom
